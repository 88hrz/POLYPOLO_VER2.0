...
INSERT INTO SanPhamChiTiet (MaSanPham, TenSanPhamChiTiet, HinhAnh, MaSize, MaMau, MaChatLieu, TrangThai, SoLuongTon, NgayNhapKho, NhanHangID, Deleted) VALUES 
										(1, N'Polo Nam Tay Dài Xanh Navy', 'C:\\Users\\X1\\OneDrive\\Documents\\NetBeansProjects\\POLYPOLO\\src\\Images\\M12_157_V2_BASELINE_FLATSQUARE.jpg', 3, 1, 1, N'Còn hàng', 100, '2024-01-01', 1, 0),
										(2, N'Polo Nữ Slim Fit Đen', NULL, 3, 4, 1, N'Còn hàng', 50, '2024-01-01', 2, 0),
										(3, N'Polo Nữ Đỏ Đô (Special Tết 2024)', NULL, 1, 2, 1, N'Còn hàng', 7, '2024-01-01', 3, 0),
										(4, N'Polo Trẻ Em Essential Trắng', NULL, 2, 3, 1, N'Còn hàng', 27, '2024-01-01', 4, 0),
										(5, N'Áo Polo Nam Đen S', NULL, 1, 1, 1, N'Còn hàng', 100, '2024-01-01', 5, 0),
										(6, N'Áo Polo Nữ Trắng M', NULL, 2, 2, 1, N'Còn hàng', 100, '2024-01-01', 6, 0),
										(7, N'Áo Polo Nữ Trắng XS', NULL, 2, 2, 1, N'Còn hàng', 100, '2024-01-01', 7, 0),
										(8, N'Polo Nam Tay Ngắn Trắng', NULL, 2, 2, 1, N'Còn hàng', 100, '2024-01-01', 8, 0),
										(9, N'Áo Polo Thư Giãn', NULL, 1, 3, 1, N'Còn hàng', 160, '2024-01-01', 1, 0),
										(10, N'Áo Polo Khám Phá', NULL, 2, 3, 1, N'Còn hàng', 170, '2024-01-01', 2, 0),
										(11, N'Áo Polo Hải Đăng', NULL, 1, 4, 1, N'Còn hàng', 180, '2024-01-01', 3, 0),
										(12, N'Áo Polo Đường Chân Trời', NULL, 3, 1, 1, N'Còn hàng', 190, '2024-01-01', 4, 0),
										(13, N'Áo Polo Cầu Vồng', NULL, 2, 2, 1, N'Còn hàng', 200, '2024-01-01', 5, 0),
										(14, N'Áo Polo Bình Minh', NULL, 3, 3, 1, N'Còn hàng', 210, '2024-01-01', 6, 0),
										(15, N'Áo Polo Hoàng Hôn', NULL, 1, 4, 1, N'Còn hàng', 220, '2024-01-01', 7, 0),
										(16, N'Áo Polo Bầu Trời Đêm', NULL, 2, 1, 1, N'Còn hàng', 230, '2024-01-01', 8, 0),
										(17, N'Áo Polo Mặt Trăng', NULL, 3, 2, 1, N'Còn hàng', 240, '2024-01-01', 1, 0),
										(18, N'Áo Polo Sao Băng', NULL, 1, 3, 1, N'Còn hàng', 250, '2024-01-01', 2, 0),
										(19, N'Áo Polo Hành Tinh', NULL, 2, 4, 1, N'Còn hàng', 260, '2024-01-01', 3, 0),
										(20, N'Áo Polo Ngân Hà', NULL, 3, 1, 1, N'Còn hàng', 270, '2024-01-01', 4, 0),
										(21, N'Áo Polo Huyền Bí', NULL, 1, 4, 2, N'Còn hàng', 75, '2024-01-02', 5, 0),
										(22, N'Áo Polo Thần Thoại', NULL, 2, 1, 2, N'Còn hàng', 85, '2024-01-03', 6, 0),
										(23, N'Áo Polo Cổ Điển', NULL, 3, 2, 2, N'Còn hàng', 95, '2024-01-04', 7, 0),
										(24, N'Áo Polo Hiện Đại', NULL, 1, 3, 2, N'Còn hàng', 105, '2024-01-05', 8, 0),
										(25, N'Áo Polo Tương Lai', NULL, 2, 4, 2, N'Còn hàng', 115, '2024-01-06', 1, 0),
										(26, N'Áo Polo Khám Phá Mới', NULL, 3, 1, 2, N'Còn hàng', 125, '2024-01-07', 2, 0),
										(27, N'Áo Polo Phiêu Lưu', NULL, 1, 2, 2, N'Còn hàng', 135, '2024-01-08', 3, 0),
										(28, N'Áo Polo Mạo Hiểm', NULL, 2, 3, 2, N'Còn hàng', 145, '2024-01-09', 4, 0),
										(29, N'Áo Polo Huyền Thoại', NULL, 3, 4, 2, N'Còn hàng', 155, '2024-01-10', 5, 0),
										(30, N'Áo Polo Huyền Ảo', NULL, 1, 1, 2, N'Còn hàng', 165, '2024-01-11', 6, 0);
----------------------------------
...
INSERT INTO KhachHang (MaHoaDon, TenKhachHang, GioiTinh, SoDienThoai, DiaChi, LoaiKhachHang, Deleted)
				VALUES (1, N'Lê Vũ', 'Nam', '0912345688', N'Hà Nội',N'Thành Viên', 0)
					...
					;
-------------------------------------------------------
INSERT INTO NhaCungCap (TenNhaCungCap, Email, SoDT, Deleted) VALUES 
											(N'Công ty TNHH Xuất Nhập Khẩu Kafergh', 'kafergh@example.com', '0123456789', 0),
											(N'Công ty CPTN Vĩnh Sơn 5', 'vinhson5@example.com', '0234567891', 0),
											(N'Hệ Thống Phân Phối Chính Hãng AngelinaJoys', 'angelinajoys@example.com', '0345678912', 0),
											(N'Công ty TNHH Xuất Nhập Khẩu Your Moms Faves', 'yourmomsfaves@example.com', '0456789123', 0),
											(N'Công ty TNHH Hybe World', 'hybeworld@example.com', '0567891234', 0),
											(N'Công ty CP Malibu', 'malibu@example.com', '0678912345', 0),
											(N'Hệ Thống Phân Phối Chính Hãng HETCYY', 'hetcuu@example.com', '0789123456', 0);
